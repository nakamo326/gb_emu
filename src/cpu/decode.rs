...
impl Cpu {
    ...
    fn cb_decode(&mut self, bus: &mut Mmu) {
        match self.ctx.opcode {
            ...
            // SET 0-7
            0xC0 => self.set_bit(bus, 0, Reg8::B),
            0xC1 => self.set_bit(bus, 0, Reg8::C),
            0xC2 => self.set_bit(bus, 0, Reg8::D),
            0xC3 => self.set_bit(bus, 0, Reg8::E),
            0xC4 => self.set_bit(bus, 0, Reg8::H),
            0xC5 => self.set_bit(bus, 0, Reg8::L),
            0xC6 => self.set_bit(bus, 0, Indirect::HL),
            0xC7 => self.set_bit(bus, 0, Reg8::A),
            0xC8 => self.set_bit(bus, 1, Reg8::B),
            0xC9 => self.set_bit(bus, 1, Reg8::C),
            0xCA => self.set_bit(bus, 1, Reg8::D),
            0xCB => self.set_bit(bus, 1, Reg8::E),
            0xCC => self.set_bit(bus, 1, Reg8::H),
            0xCD => self.set_bit(bus, 1, Reg8::L),
            0xCE => self.set_bit(bus, 1, Indirect::HL),
            0xCF => self.set_bit(bus, 1, Reg8::A),
            0xD0 => self.set_bit(bus, 2, Reg8::B),
            0xD1 => self.set_bit(bus, 2, Reg8::C),
            0xD2 => self.set_bit(bus, 2, Reg8::D),
            0xD3 => self.set_bit(bus, 2, Reg8::E),
            0xD4 => self.set_bit(bus, 2, Reg8::H),
            0xD5 => self.set_bit(bus, 2, Reg8::L),
            0xD6 => self.set_bit(bus, 2, Indirect::HL),
            0xD7 => self.set_bit(bus, 2, Reg8::A),
            0xD8 => self.set_bit(bus, 3, Reg8::B),
            0xD9 => self.set_bit(bus, 3, Reg8::C),
            0xDA => self.set_bit(bus, 3, Reg8::D),
            0xDB => self.set_bit(bus, 3, Reg8::E),
            0xDC => self.set_bit(bus, 3, Reg8::H),
            0xDD => self.set_bit(bus, 3, Reg8::L),
            0xDE => self.set_bit(bus, 3, Indirect::HL),
            0xDF => self.set_bit(bus, 3, Reg8::A),
            0xE0 => self.set_bit(bus, 4, Reg8::B),
            0xE1 => self.set_bit(bus, 4, Reg8::C),
            0xE2 => self.set_bit(bus, 4, Reg8::D),
            0xE3 => self.set_bit(bus, 4, Reg8::E),
            0xE4 => self.set_bit(bus, 4, Reg8::H),
            0xE5 => self.set_bit(bus, 4, Reg8::L),
            0xE6 => self.set_bit(bus, 4, Indirect::HL),
            0xE7 => self.set_bit(bus, 4, Reg8::A),
            0xE8 => self.set_bit(bus, 5, Reg8::B),
            0xE9 => self.set_bit(bus, 5, Reg8::C),
            0xEA => self.set_bit(bus, 5, Reg8::D),
            0xEB => self.set_bit(bus, 5, Reg8::E),
            0xEC => self.set_bit(bus, 5, Reg8::H),
            0xED => self.set_bit(bus, 5, Reg8::L),
            0xEE => self.set_bit(bus, 5, Indirect::HL),
            0xEF => self.set_bit(bus, 5, Reg8::A),
            0xF0 => self.set_bit(bus, 6, Reg8::B),
            0xF1 => self.set_bit(bus, 6, Reg8::C),
            0xF2 => self.set_bit(bus, 6, Reg8::D),
            0xF3 => self.set_bit(bus, 6, Reg8::E),
            0xF4 => self.set_bit(bus, 6, Reg8::H),
            0xF5 => self.set_bit(bus, 6, Reg8::L),
            0xF6 => self.set_bit(bus, 6, Indirect::HL),
            0xF7 => self.set_bit(bus, 6, Reg8::A),
            0xF8 => self.set_bit(bus, 7, Reg8::B),
            0xF9 => self.set_bit(bus, 7, Reg8::C),
            0xFA => self.set_bit(bus, 7, Reg8::D),
            0xFB => self.set_bit(bus, 7, Reg8::E),
            0xFC => self.set_bit(bus, 7, Reg8::H),
            0xFD => self.set_bit(bus, 7, Reg8::L),
            0xFE => self.set_bit(bus, 7, Indirect::HL),
            0xFF => self.set_bit(bus, 7, Reg8::A),
        }
    }
