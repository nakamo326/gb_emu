...
impl Cpu {
    pub fn decode(&mut self, bus: &mut Peripherals) {
        ...
        match self.ctx.opcode {
            ...
            // 0x09 => self.add16(bus, Reg16::HL, Reg16::BC),
            ...
            // 0x17 => self.rla(bus),
            0x18 => self.jr(bus),
            // 0x19 => self.add16(bus, Reg16::HL, Reg16::DE),
            ...
            // 0x29 => self.add16(bus, Reg16::HL, Reg16::HL),
            ...
            0x34 => self.inc16(bus, Indirect::HL),
            0x35 => self.dec16(bus, Indirect::HL),
            0x36 => self.ld(bus, Indirect::HL, Imm8),
            // 0x37 => self.scf(bus),
            0x38 => self.jr_c(bus, Cond::C),
            // 0x39 => self.add16(bus, Reg16::HL, Reg16::SP),
            ...
            // 0xE8 => self.add16(bus, Reg16::SP, Imm8),
            // 0xE9 => self.jp(bus, Reg16::HL),
            0xEA => self.ld(bus, Direct8, Reg8::A),
            ...
            0xFA => self.ld(bus, Reg8::A, Direct8),
            // 0xFB => self.ei(bus),
